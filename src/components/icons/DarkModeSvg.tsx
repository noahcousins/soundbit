...
export default function DarkModeSvg() {
  ...
  const isDarkModeInitially = resolvedTheme === 'dark';
  const [isLoading, setIsLoading] = useState(resolvedTheme === 'no-preference');
  const [isDarkMode, setIsDarkMode] = useState(isDarkModeInitially);
